...
class Dificultad(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        def select_difficulty(event):
            ...
            # Aqui iria un enlace a mas bien ir a alguna patnalla en negro? 
            controller.show_frame("ScoreInput")
            

        # Contenedor principal
        container = (root, fg_color="#333333")
        # Fondo oscuro
        #   Aqui esta el margen
        ...
        self.bind("<Key>", select_difficulty)
